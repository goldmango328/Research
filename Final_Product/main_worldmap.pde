...
void control_type(){  
  ...
  text(selectedType, typeboxLeft[0]+textWidth("Choose Type")+grid_gap*2, typeboxTop[0]-grid_gap);
  text(columnName[selectedType], typeboxLeft[0]+textWidth("Choose Type 0")+grid_gap*2, typeboxTop[0]-grid_gap);
